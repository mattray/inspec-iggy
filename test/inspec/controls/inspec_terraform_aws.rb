...
control "inspec terraform generate --name AWS-terraform-two-tier" do
  ...
  describe file "#{tmp_dir}/AWS-terraform-two-tier/inspec.yml" do
    ...
    its("content") { should match(%r{description: Generated by InSpec-Iggy v0.8.0 from the test/fixtures/terraform/tfstates/aws-terraform-two-tier-example.tfstate$}) }
  ...
  describe file "#{tmp_dir}/AWS-terraform-two-tier/README.md" do
    its("content") { should match(/#*AWS-terraform-two-tier$/) }
    its("content") { should match(%r{^This profile was generated by InSpec-Iggy v0.8.0 from the test/fixtures/terraform/tfstates/aws-terraform-two-tier-example.tfstate source file.$}) }
  end
  ...
  describe file "#{tmp_dir}/AWS-terraform-two-tier/controls/generated.rb" do
    ...
    its("content") { should match(/title "AWS-TERRAFORM-TWO-TIER: generated by Iggy v0.8.0"$/) }
  ...
  describe file "#{tmp_dir}/AWS-terraform-elb-example/inspec.yml" do
    ...
    its("content") { should match(/version: 1.2.3$/) }
    its("content") { should match(%r{description: Generated by InSpec-Iggy v0.8.0 from the test/fixtures/terraform/tfstates/aws-terraform-elb-example.tfstate$}) }
    its("content") { should match(/inspec_version: "~> 4"$/) }
    its("content") { should match(/depends:$/) }
    its("content") { should match(/- name: inspec-aws$/) }
    its("content") { should match(%r{url: https://github.com/inspec/inspec-aws/archive/master.tar.gz$}) }
  ...
  describe file "#{tmp_dir}/AWS-terraform-elb-example/README.md" do
    its("content") { should match(/#*AWS-terraform-elb-example$/) }
    its("content") { should match(%r{^This profile was generated by InSpec-Iggy v0.8.0 from the test/fixtures/terraform/tfstates/aws-terraform-elb-example.tfstate source file.$}) }
  end

  describe file "#{tmp_dir}/AWS-terraform-elb-example/controls/generated.rb" do
    its("content") { should match(/Generated by InSpec-Iggy v0.8.0$/) }
    ...
    its("content") { should match(/title "AWS-TERRAFORM-ELB-EXAMPLE: generated by Iggy v0.8.0"$/) }
